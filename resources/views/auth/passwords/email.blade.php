...
<div class="block push-bit">
     @if (session('status'))
                    ...
                    @endif
<form action="{{ route('password.email') }}" method="POST" class="form-horizontal form-bordered form-control-borderless">
    @csrf
...
<a href="{{ route('login') }}"><small>Je me souviens de mon mot de passe !</small></a>
</div>
</div>
</form>
</div>
