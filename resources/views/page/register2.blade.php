...
<input type="text" id="fos_user_registration_form_firstName" name="name" required="required" maxlength="255" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Prénom" class="form-control" value="{{ old('name') }}" required autofocus />
@if ($errors->has('name'))
...
<div class="col-xs-6">
<input type="text" id="fos_user_registration_form_lastName" name="prenom" required="required" maxlength="255" class="form-control" placeholder="Nom" class="form-control" />
</div>
</div>
<div class="form-group ">
<div class="col-xs-12">
...
<input type="checkbox" id="fos_user_registration_form_acceptCGU" name="fos_user_registration_form[acceptCGU]" required="required" class="check">
...
<div class="g-recaptcha" data-sitekey="6LfLA0gUAAAAAP9vxZa27gACDdGrFT_3vaDMxrqF"></div>
