...
<form action="/login_check" method="post" id="form-login" class="form-horizontal form-bordered form-control-borderless">
    @csrf
...
<input type="text" id="login-email" name="_username" class="form-control input-lg" placeholder="Adresse e-mail" value="{{ old('email') }}" required autofocus>
@if ($errors->has('email'))
...
<input type="password" id="login-password" name="_password" class="form-control input-lg{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="Mot de passe" required>
...
<a href="href="{{ route('password.request') }}"" id="link-reminder-login"><small>J&#039;ai oublié mon mot de passe</small></a> -
<a href="href="{{ route('register') }}"" id="link-register-login"><small>Créer un compte utilisateur</small></a>
</div>
</div>
</form>
